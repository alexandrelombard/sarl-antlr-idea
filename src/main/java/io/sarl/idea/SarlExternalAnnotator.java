 ...
 */
public class SarlExternalAnnotator extends ExternalAnnotator<PsiFile, List<SarlExternalAnnotator.Issue>> {
...
//			XPath.findAll(SarlLanguage.INSTANCE, file, "/script/function/ID");
//		Collection<? extends PsiElement> funcCallNameNodes =
//			XPath.findAll(SarlLanguage.INSTANCE, file, "//call_expr/ID");
//
